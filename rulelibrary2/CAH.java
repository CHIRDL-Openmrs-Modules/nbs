/********************************************************************
 Translated from - CAH.mlm on Sat Jun 11 22:46:09 EDT 2011
...
return false;
	...
	private boolean evaluate_logic(Map<String, Object> parameters) throws LogicException {
		...
		if((!endocrine.isNull()&&endocrine.toString().equalsIgnoreCase("OH-F-06-002"))){
			return true;
		}
}	return false;	}
