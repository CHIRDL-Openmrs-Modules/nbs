/********************************************************************
 Translated from - RTA.mlm on Sat Jun 11 22:38:09 EDT 2011
...
return false;
	...
	private boolean evaluate_logic(Map<String, Object> parameters) throws LogicException {
		...
		if((!mode.isNull()&&mode.toString().equalsIgnoreCase("PRODUCE"))){
				Result CahText = logicService.eval(patient, "CAH",parameters);
				resultLookup.put("CahText",CahText);
		if(!(CahText.isNull())){
				varLen = "CAH".length();
	...
	public void initAction() {
		...
		actions.add("|| CahText_value ||@paragraphOneText");
	}
