...
public class PatientHandler extends org.openmrs.module.sockethl7listener.PatientHandler
{
			...
			Location sendingFacility, HL7PatientHandler hl7PatientHandler)
	{
		...
		if (hl7PatientHandler instanceof org.openmrs.module.nbs.hl7.mrfdump.HL7PatientHandler23)
		{
			// patient ssn
			String ssn = ((org.openmrs.module.nbs.hl7.mrfdump.HL7PatientHandler23) hl7PatientHandler)
					.getSSN(message);
			if (ssn != null)
			{
			...
			// patient religion
			String religion = ((org.openmrs.module.nbs.hl7.mrfdump.HL7PatientHandler23) hl7PatientHandler)
					.getReligion(message);
			if (religion != null)
			{
			...
			String marital = ((org.openmrs.module.nbs.hl7.mrfdump.HL7PatientHandler23) hl7PatientHandler)
			...
			String maiden = ((org.openmrs.module.nbs.hl7.mrfdump.HL7PatientHandler23) hl7PatientHandler)
