...
public class NbsProvidersCron extends AbstractTask
{
	...
	public void execute()
	{
		...
		try
		{
			...
			log.info("nbs Providers were retired last on: " + lastRunDate.toString());
	...
	private void init()
	{
		...
		try
		{
			...
			retireProvidersPriorToDays = -Integer.parseInt(adminService.getGlobalProperty("nbs.retireProvidersPeriod"));  // in days
