...
public class formInstanceId implements Rule
{
	...
	{
		if (parameters != null && parameters.get("formInstanceId") != null)
		{
			Integer formInstanceId = (Integer) parameters.get("formInstanceId");
			if (formInstanceId != null)
			{

				return new Result(String.valueOf(formInstanceId));
			}
		}
